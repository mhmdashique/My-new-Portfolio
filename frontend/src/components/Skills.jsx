  ...
  const skillCategories = [
    {
      ...
      skills: skills.frontend.map((skill) => ({
        name: skill,
        logo: logoMap[skill] || "https://img.icons8.com/color/48/code.png",
      })),
      color: "#61dafb",
    ...
    },
    {
      ...
      skills: skills.backend.map((skill) => ({
        name: skill,
        logo: logoMap[skill] || "https://img.icons8.com/color/48/server.png",
      })),
      color: "#68d391",
    ...
    {
      title: "Database",
      skills: skills.database.map((skill) => ({
        name: skill,
        logo: logoMap[skill] || "https://img.icons8.com/color/48/database.png",
      })),
      color: "#f6ad55",
    ...
    },
    {
      ...
      skills: skills.tools.map((skill) => ({
        name: skill,
        logo: logoMap[skill] || "https://img.icons8.com/color/48/toolbox.png",
      })),
      color: "#fc8181",
